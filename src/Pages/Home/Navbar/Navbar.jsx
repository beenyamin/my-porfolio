...
const Navbar = () => {
    ...
    return (
        <div className="pt-5 pl-8 md:pl-24 ">
            <div className="flex shadow-2xl md:w-9/12  mx-auto fixed bg-opacity-80 rounded-full bg-white">
                ...
                <div className="">
                    <h2 className="mt-2 ml-32 pr-16 md:pr-0 md:ml-0 text-2xl"> <FontAwesomeIcon icon={faToggleOff} />
                    </h2>
